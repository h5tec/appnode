...
RUN          apt-get update && apt-get upgrade -y && \
             ...
             pip install --no-cache-dir psutil aiohttp tornado motor pymongo dnspython websocket-client speedtest-cli tormysql pandas qrcode requests ipaddress six wrapt && \
